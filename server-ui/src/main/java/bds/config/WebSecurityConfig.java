...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/", "/home", "/routes", "/payments", "/routes/**", "/payments/**","/askTrack", "/askTrackPage", "/showTrackPage","/addTrackPage","/addTrack","/notDone","/editTrackPage","/delTrackPage").access("hasRole('CLIENT') or hasRole('MANAGER') or hasRole('ROOT')")
